...
CIFAR_100i="--n_layers 2 --n_hiddens 100 --data_path data/ --save_path results_icarl_test/ --batch_size 10 --log_every 100 --samples_per_task 2500 --data_file cifar100.pt  --cuda yes --seed 0"
...
# CUDA_VISIBLE_DEVICES=1 $MY_PYTHON main.py $CIFAR_100i --model gem --lr 0.1 --n_memories 256 --memory_strength 0.5

# plot results
cd results_icarl_test/
