...
parser.add_argument('--net_name', type=str, required=True, help='name of basenet')  # resnet20/resnet110/CLIP
...
def encode(images, clip_model):
		...
		with torch.no_grad():
			...
			features = clip_model.encode_image(images.to(device)).view(-1)
